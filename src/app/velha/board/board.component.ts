...
export class BoardComponent implements OnInit {
   ...
   */
  @Input() public scoreboardPlayer1 = 0;
  /**
   * Contador de Pontos do Jogador 2
   */
  @Input() public scoreboardPlayer2 = 0;
  /**
  ...
  /**
   * @param info - Serviço de Informações
   */
   ...
   *
   * @param jogador - Recebe o Jogador atual
   */
  private LogicalVerify(jogador: Number) {
    ...
    if (firstLineVerifier === 3 || secondLineVerifier === 3 ||
        thirdLineVerifier === 3 || firstCollumnVerifier === 3 ||
        secondCollumnVerifier === 3 || thirdCollumnVerifier === 3 ||
        diagonalVerifier === 3 || leftDiagonalVerifier === 3) {
   ...
   * @param velha - Se o Jogo Deu Velha
   */
  ...
  /**
   * Transmite as mudanças para os outros componentes
   */
  public EmitChanges() {
